...
export function ProjectsCard({id, index, duration, name, role, image}: ProjectProps) {
  ...
  return (
    <CardContainer className="inter-var">
      <CardBody key={index} className="group/card relative h-auto w-auto rounded-xl border motion-preset-expand motion-duration-700 border-black/[0.1] bg-gray-50 bg-opacity-75 p-6 dark:border-white/[0.2] dark:bg-black dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] sm:w-[30rem]">
        <CardItem
          translateZ="50"
